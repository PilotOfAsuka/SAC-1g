...
setting_button_list = ['👤 Изменить имя', '🌿 Изменить название удобрения', '📅 Установить дату посева', 'ВЫБРАТЬ БОКС', "Харвест"]
...
settings_menu_actions = {
    ...
    setting_button_list[4]: ('harvest', "Вы хотите установить статус 'Харвест'?", check_menu)
}
